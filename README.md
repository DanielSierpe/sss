    ...
    <div class="login-container">
        ...
        <form id="loginForm">
            <div class="form-group">
                ...
                <label for="username" class="input-label">RUT Funcionarios (Ej: 122748426)</label>
            </div>

            <div class="form-group">
                <input type="password" id="password" class="input-field" placeholder=" ">
                <label for="password" class="input-label">Clave de acceso Intranet</label>
            </div>
    ...
    <script>
        ...
        function handleForm() {
            ...
            loginBtn.addEventListener('click', function() {
                ...
                // Solo efecto visual - simular loading
        ...
        function addHoverEffects() {
            ...
            // Solo efecto hover simple sin movimiento 3D
